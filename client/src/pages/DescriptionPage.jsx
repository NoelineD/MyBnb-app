...
export default function DescriptionPage() {
    ...
    return (
        <div className="mt-8 bg-gray-100 px-8 mx-8 py-4">
            ...
            <div className="relative">
                <div className="grid gap-2 grid-cols-[2fr_1fr] rounded-3xl overflow-hidden">
                    <div> {place.addedPhotos?.[0] && (
                        <div>
                        <img className="aspect-square object-cover" src={"http://localhost:4000/uploads/" +place.addedPhotos[0]} alt=""></img>
                        </div>
                    )}
                    </div>
                    ...
                    <div className="grid">
                    {place.addedPhotos?.[1] && (
                        <img className="aspect-square object-cover" src={"http://localhost:4000/uploads/" +place.addedPhotos[1]} alt=""></img>
                        )}
                    <div className="overflow-hidden">
                    {place.addedPhotos?.[2] && (
                        <img className="aspect-square object-cover relative top-2" src={"http://localhost:4000/uploads/" +place.addedPhotos[2]} alt=""></img>
                         )} 
                    </div>
                    </div>
                </div>
